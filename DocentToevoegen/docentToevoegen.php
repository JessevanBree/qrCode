...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php header(refresh;) ?>">QR-Code</a>
        ...
        if (isset($_POST["naamDocent"]) && ($_POST["leeftijd"]) && ($_POST["lesVak"]) && ($_POST["opleiding"]) && ($_POST["favvak"]) && ($_POST["beschrijving"])){
            ...
            echo "" . $_POST["naamDocent"] . " NaamD " . $_POST["leeftijd"] . " Leeftijd " . $_POST["lesVak"] . " LV " . $_POST["opleiding"] . " OPL " . $_POST["favvak"] . " FAV " . $_POST["beschrijving"] . " besc";
        }   else {
